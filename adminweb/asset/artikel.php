<?php
$database = "asset/database/artikel.php";
...
}elseif (isset($_GET['page']) && $_GET['page']=='terbit') {
	include "artikel_terbit.php";
}elseif (isset($_GET['page']) && $_GET['page']=='konsep') {
	include "artikel_konsep.php";
}else{
?>
...
<div class="clear"></div>
		...
		<table class="tabel" id="results">
			...
			<?php
				$no=1;
				$link=mysql_query("SELECT * FROM artikel ORDER BY kd_artikel DESC");
