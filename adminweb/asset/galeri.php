...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
				...
				$galeri=mysql_query("SELECT id_galeri, tanggal_galeri, nama_galeri, id_album, nama_album FROM galeri natural join album_galeri ORDER BY id_galeri DESC");
				...
				echo "Photo Berdasarkan $g[nama_album] tidak ada";
			}
			?>
		</table>
