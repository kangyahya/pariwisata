...
<div class="judulbox">Komentar Artikel</div>
		...
		<div class="tombol">
			...
			$komentar=mysql_query("SELECT * FROM komentar_artikel, artikel WHERE komentar_artikel.kd_artikel=artikel.kd_artikel AND status='0' ORDER BY kd_komartikel DESC");
			}
			...
			<tr class="tabel">
				...
				<?php if ($kom[status]== 1) {
				echo "
					<div class='hapusdata'><a href='$database?page=komentar&untukdi=hapus&id=$kom[id_komentar]'>hapus</a></div>
