...
<div class="judulbox">Komentar Artikel</div>
		...
		<div class="tombol">
			...
			$komentar=mysql_query("SELECT * FROM komentar_artikel, artikel WHERE komentar_artikel.kd_artikel=artikel.kd_artikel AND status='1' ORDER BY kd_komartikel DESC");
			}
