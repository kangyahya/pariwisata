...
<div id="wrapper"><!--Awal id wrapper-->
	...
	<div id="konten"><!--Awal id konten-->
		<div id="samping"><!--Awal id samping-->
			...
			<div class="menu"><div class="isimenuHome aktif"><a href="penginapan.php">Penginapan</a></div></div>
			<div class="menu"><div class="isimenuKelas"><a href="komentar.php">Komentar</a></div></div>
