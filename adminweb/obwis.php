...
<div id="wrapper"><!--Awal id wrapper-->
	...
	<div id="konten"><!--Awal id konten-->
		<div id="samping"><!--Awal id samping-->
			...
			<div class="menu"><div class="isimenuBuku aktif"><a href="obwis.php">Lokasi Objek Wisata</a></div></div>
			...
			<div class="menu"><div class="isimenuBuku"><a href="komentar.php">Komentar</a></div></div>
